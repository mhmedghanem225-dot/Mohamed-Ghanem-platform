...
export default function AchievementsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] p-6 text-right" dir="rtl">
      ...
      {/* --- تصميم الشهادة الإنجليزية (يظهر عند الطباعة/التحميل فقط) --- */}
        ...
        <div className="border-4 border-[#FFC107] h-full w-full p-8 flex flex-col justify-between items-center relative">
          ...
          <div className="w-full flex justify-between items-end px-12 mt-10">
            ...
            <div className="flex flex-col items-center">
              <div className="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center border-2 border-blue-600 mb-2">
                 <span className="text-blue-600 font-black text-[10px] text-center leading-tight tracking-tighter">GHANEM<br/>ACADEMY</span>
              </div>
              <p className="text-[10px] uppercase font-bold text-blue-400 tracking-widest">Verified</p>
            </div>
