...
function LessonsContent() {
  ...
  // تحويل روابط YouTube المختلفة إلى رابط Embed
  ...
  const handleWatchLesson = async (
    ...
    // تحديث حالة الدرس كمكتمل محلياً
  ...
  // إغلاق الفيديو عند الضغط على زر Escape
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-50 pb-36" dir="rtl">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center justify-between gap-3 relative z-10 mb-6">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              >
                ...
                <span className="text-[11px] font-black text-blue-900 whitespace-nowrap">
                  Speak Now
                </span>
              </button>
          ...
          <div className="relative z-10 text-white flex justify-between items-end gap-3">
            ...
            <div className="text-right min-w-0">
              ...
              <p className="text-blue-100 font-bold text-xs mb-1 truncate">
                Welcome, {studentName} 👋
              </p>
            ...
            <div className="bg-white/20 backdrop-blur-md px-3 py-2 rounded-xl border border-white/30 text-center min-w-[72px] shrink-0">
              ...
              <p className="text-[9px] font-bold text-blue-50">
                Points
              </p>

              <p className="text-xl font-black text-[#FFEB3B]">
                {points}
              </p>
          ...
          <div className="space-y-3">
            ...
            {Object.keys(units).map((unitName) => {
              ...
              const completedCount = unitLessons.filter((l) =>
                completedLessons.includes(l.title)
              ).length;
                    ...
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span
                        className={`text-sm text-gray-400 transition-transform duration-300 ${
                          openUnits[unitName] ? "rotate-180" : ""
                        }`}
                      >
                        ▼
                      </span>

                      <span className="font-black text-gray-700 text-sm sm:text-[15px] flex-1 mx-3">
                        {unitName}
                      </span>
                              ...
                              <button
                                ...
                                className={`${
                                  isCompleted
                                    ? "bg-green-500"
                                    : "bg-blue-600"
                                } text-white w-9 h-9 rounded-full flex items-center justify-center shadow-md active:scale-90 transition-transform text-xs shrink-0`}
                              >
                                {isCompleted ? "✔" : "▶️"}
                              </button>
                            ...
                            <div className="flex gap-2">
                              ...
                              {lesson.keywords && (
                                <button
                                  onClick={() =>
                                    router.push(
                                      `/flashcards?title=${encodeURIComponent(
                                        lesson.title
        ...
        >
          ...
          <div className="w-full max-w-3xl bg-white rounded-[2rem] shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center justify-between gap-3 px-4 py-3 bg-white border-b border-gray-100">
              ...
              <button
                onClick={closeVideo}
                className="w-10 h-10 rounded-full bg-red-50 text-red-600 flex items-center justify-center text-lg font-black active:scale-90 transition-all shrink-0"
                aria-label="Close video"
              >
                ✕
              </button>

              <h2 className="text-sm font-black text-gray-800 text-right truncate">
                {activeLessonTitle}
              </h2>
      ...
      <div className="fixed bottom-3 left-3 right-3 sm:left-10 sm:right-10 bg-white/95 backdrop-blur-md p-2 rounded-[1.8rem] shadow-2xl border border-gray-100 z-50">
        ...
        <div className="grid grid-cols-4 items-center">
          ...
          <button
            onClick={() => router.push("/profile")}
            className="flex flex-col items-center gap-0.5 p-1 active:scale-75 transition-all"
          >
          ...
          <button className="flex flex-col items-center gap-0.5 p-1 relative">
            ...
            <span className="text-[9px] font-black text-[#1D63ED]">
              Lessons
            </span>
