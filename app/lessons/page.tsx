...
// استدعاء الدالة للتحديث التلقائي
...
function LessonsContent() {
  ...
  // دالة التعامل مع فتح الدرس مع التحديث التلقائي
  const handleWatchLesson = (videoUrl: string) => {
    // 1. التحديث التلقائي في الشيت (في الخفاء)
                    ...
                    {units[unitName].map((lesson, idx) => (
                      <div key={idx} className="p-4 rounded-[1.5rem] border border-gray-50 bg-gray-50/30 text-right">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          {/* استبدال رابط الـ a بالدالة المحدثة */}
